...
//         <div
//           key={index}
//           className="flex items-center justify-between border-b py-4 hover:bg-gray-50 cursor-pointer"
//         >
//           <div>
...
//           <span className="text-xs text-orange-500 bg-orange-100 px-3 py-1 rounded-full">
//             {mail.time}
//           </span>
//         </div>
//       ))}
...
//     id: 2,
//     to: "Support",
//     subject: "Issue with login - I am having trouble logging in...",
//     time: "Sent",
//     starred: true,
//   },
// ];
...
//                             {/* Preview */}
//                             <span className="text-gray-400 truncate max-w-[420px]">
//                                 - {mail.preview}
//                             </span>
//                         </div>
//                     </div>
