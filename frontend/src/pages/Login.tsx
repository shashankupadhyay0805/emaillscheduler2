...
//       <div className="w-[380px] rounded-xl bg-white p-8 shadow-md">
//         {/* Title */}
...
//         <button
//           onClick={() => googleLogin()}
//           className="mb-4 flex w-full items-center justify-center gap-2 rounded-md bg-green-50 py-3 text-sm font-medium text-gray-700 transition hover:bg-green-100"
//         >
//           <img
